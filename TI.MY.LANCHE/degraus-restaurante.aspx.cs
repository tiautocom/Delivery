...
{
    public partial class degraus_restaurante : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                if (dadosTabela.Rows.Count > 0)
                {
                    for (int i = 0; i < dadosTabela.Rows.Count; i++)
                    {
                        ...
                        layoutIndex += departamentoRegraNegocios.GerarCardsDepartanentos(id, url, desc, descDep, "degraus-restaurante.aspx");
                    }
