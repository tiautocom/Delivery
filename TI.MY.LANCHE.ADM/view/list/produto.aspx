...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
     <div class="input-group mb-12">
        ...
        <div class="table-responsive">
            <asp:GridView ID="gdvpRODUTO" runat="server" Width="100%" CssClass="table table-striped" AutoGenerateColumns="False" ShowHeader="False" HorizontalAlign="Center" UseAccessibleHeader="False">
                <Columns>
                    ...
                    <asp:TemplateField Visible="False">
                        <ItemTemplate>
                            <asp:Label ID="lbDescricao" runat="server" Text='<%# Bind("DESCRICAO") %>' Width="200px"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField>
                        <ItemTemplate>
