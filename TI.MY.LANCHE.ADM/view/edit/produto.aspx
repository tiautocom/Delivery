<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="produto.aspx.cs" Inherits="TI.MY.LANCHE.ADM.view.edit.produto" %>
    ...
    <div class="container1">
        <div class="row">
            <div class="form-group col-md-6">
                <h3 class="page-header">Editar Produto
                  <asp:Label ID="lblIdProduto" runat="server" Text=""></asp:Label>
            <div class="form-group col-md-6">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <asp:Button ID="Add" class="btn btn-success" runat="server" Text="Salvar Alteração" OnClick="Add_Click" />
                ...
                <a href='javascript:history.go(-1)' class="btn btn-info">Lista</a>
