    ...
    public class DepartamentoRegraNegocios
    {
        ...
        public string GerarIndex(int id, string url, string descrica, string detalhes, string preco, int cont)
        {
            try
            {
                ...
                //sb.Append("<td>");
                //sb.Append("<input type=\"number\" value=\"1\" max=\"5\" min=\"0\" class=\"quantidade\"/>");
                //sb.Append("</td>");
                //sb.Append("<td class=\"btn btn-outline-dark\">");
                //sb.Append("<span class=\"preco-produto\" >R$ 129,90</span>");
                //sb.Append("</td>");
