<%@ Page Title="APP Lu Lanches" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="lu-lanches.aspx.cs" Inherits="TI.MY.LANCHE.lu_lanches" %>
    ...
    <div class="shadowBox">
        ...
        <script>
            ...
            function AddCarrinho(produto, qtd, valor, posicao, obs) {
                ...
                window.location.href = "lu-lanches.aspx";
            }
